...
import { getData, getDataKey, getMessage, getValidations, withValidation } from "@/utils/helpers";
...
const Page = () => {
  ...
  const submit = methods.handleSubmit(async (values) => {
    try {
      const response = await api.transaction.update(id, values);
  ...
  useEffect(() => {
    ...
    const fetch = async () => {
      try {
        ...
        methods.setValue("cost_center_id", getDataKey(response, "cost_center_id"));
        methods.setValue("account_plan_id", getDataKey(response, "account_plan_id"));
        methods.setValue("description", getDataKey(response, "description"));
        methods.setValue("amount", getDataKey(response, "amount"));
        methods.setValue("date", dayjs.utc(getDataKey(response, "date")));
        methods.setValue("operation", getDataKey(response, "operation"));
  ...
  return (
    <FormProvider {...methods}>
      ...
      >
        <DialogTitle color="primary">Edit Transaction</DialogTitle>

        <DialogContent>
          <DialogContentText>
            Fill in the information below to edit the transaction.
          </DialogContentText>
