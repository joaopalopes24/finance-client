...
const Page = () => {
  ...
  const submit = methods.handleSubmit(async () => {
    try {
      const response = await api.accountPlan.delete(params.id as string);
  ...
  return (
    <FormProvider {...methods}>
      ...
      >
        <DialogTitle color="primary">Delete Account Plan</DialogTitle>

        <DialogContent>
          <DialogContentText>
            Do you really want to delete this account plan?
          </DialogContentText>
        </DialogContent>
